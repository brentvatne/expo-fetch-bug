  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View>
          <Text>This button will cause an error as it tries to upload a local file</Text>
          <Button
            ...
            styles={{flex:1}}
          />
          <Text>This button will not cause an error as it tries to upload a file from 'https://facebook.github.io/react/logo-og.png'</Text>
          <Button
